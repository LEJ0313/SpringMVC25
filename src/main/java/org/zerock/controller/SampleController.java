...
@Controller // servlet-context.xml 에서 <context:component-scan base-package="org.zerock.controller" /> 용
...
public class SampleController {
	...
	public void basic() {
		...
		// 리턴이 void임 : log.info("리턴이 void이기 때문에 basic.jsp 파일을 찾습니다.");
	...
	public String ex01(SampleDTO dto) { // SampleDTO dto = new SampleDTO();
		...
		return "mbcex01"; // WEB-INF/views/ex01.jsp 를 찾는다 -> servlet-context.xml이 하는 일
	} // ex01() 메서드 종료
	...
	public String ex02(@RequestParam("owner") String name, @RequestParam("age") int age) {
		// 프론트 변수와 백엔드의 변수가 다를 때 (초보자는 일치 시킬것)		

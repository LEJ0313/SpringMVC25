...
public class MemberController {
    ...
    @GetMapping("/profile")
    public String profileGet(@AuthenticationPrincipal MemberSecurityDTO memberSecurityDTO, Model model) {

        String mid = memberSecurityDTO.getUsername();

        log.info("MemberController.profileGet..... ");
        log.info("mid: " + mid);

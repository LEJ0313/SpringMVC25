...
@AllArgsConstructor // 생성자 자동 주입 ( 모든 필드를 보고 생성자를 만듦)
public class BoardController {
	...
	public void list(Model model) {
		...
		// 프론트에서 ${list} 로 활용한다. (for문을 사용해야 할 것)
		
	}
	
	@PostMapping("/register")
	public String register(BoardVO board, RedirectAttributes rttr) {
		// RedirectAttributes 성공 후 이동할 경로를 기입한다.
	...
	public String modify(BoardVO board, RedirectAttributes rttr) {
		// 프론트에서 수정된 boardVO가 넘어오면 update 쿼리가 실행되고 결과가 boolean으로 나온다.
		log.info("BoardController.get 메서드 실행.............");

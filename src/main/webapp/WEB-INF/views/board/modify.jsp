...
$(document).ready(function(){
	...
	$('button').on("click",function(e){
		...
		console.log(operation); //크롬부라우저 콘솔에 값이 찍힘
		
		if(operation === 'remove'){
			formObj.attr("action","/board/remove");
			// data-oper='remove' -> /board/remove 로 보내라
		}else if(operation === 'list'){
			self.location="/board/list";
			return;
			// data-oper='list' -> /board/list 로 보내라
		}
		// data-oper='modify'는 기본 액션 태그에 내용대로 진행됨
		
		formObj.submit(); // submit 버튼이 동작한다.
